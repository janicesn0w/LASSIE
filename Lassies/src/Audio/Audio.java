...
public class Audio{
	...
	public static Audio die = new Audio("/SFX/die.mp3");
	public static Audio nextlevel = new Audio("/SFX/nextlevel.mp3");
	public static Audio[] music = {menu, level1,level2,level3,level4,level5, die, nextlevel};
