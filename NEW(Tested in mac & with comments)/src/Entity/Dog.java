...
public class Dog extends Objects{
	...
	//draw the dog on the map(facing right, left and stationery)
	public void draw(Graphics2D g) {
		setMapPosition();
		
		if(stationery) {
			long elapsed =
				(System.nanoTime() - stationeryTimer) / 1000000;
			if(elapsed / 100 % 2 == 0) {
				return;
			}
		}
	...
	//check the game time whether it reaches 0
